...
if ($emailstatus == 1) {
    if ($content) {
        ...
        $mail->SetFrom($emailuser.'@qq.com', '微云系统');
        $mail->AddReplyTo($emailuser.'@qq.com', '微云系统');
...
<div>请尽快登陆微云进行信息处理[<a href='http://dkjingyou.gotoip1.com/index.php?m=Index&a=login' target='_blank'>点击进入</a>]</div>
