...
'license'=>'<div class="license"><h1>系统安装协议</h1>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 微云微信公共平台，还是部份栏目使用 微云微信公共平台，在你使用了 微云微信公共平台的网站主页上必须加上 微云微信公共平台  官方淘宝网址(<a href="http://uuuya.taobao.com" target="_blank">uuuya.taobao.com</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 微云微信公共平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：</b> 2014年2月10日</p>
                <p align=right>BY 微云微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微云微信公共平台V'.SOFT_VERSION.' 安装程序',
...
?>
			<div class="footer">
			    <p>Powered by 微云微信公共平台© v5.0 2013-2014</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
