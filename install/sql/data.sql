...
INSERT INTO `tp_classify` (`id`, `name`, `info`, `sorts`, `img`, `url`, `icon`, `yanse`, `status`, `token`) VALUES
(1, '分类A', '分类A', '1', '/Uploads/image/20140208/52f643917e30d.png', '', 'icon-thumbs-up', '#FFFFFF', '1', 'idgzas1391869476'),
(3, '测试分类二', '测试分类二', '1', 'http://mywx.n.ydgood.com/img/fenlei.jpg', '', 'icon-camera', '#FFFFFF', '1', 'idgzas1391869476'),
(4, '宝宝照', '宝宝照', '1', 'http://mywx.n.ydgood.com/img/fenlei.jpg', '', '', '#FFFFFF', '1', 'pioqvg1392027725');
...
(1, 'pzjxew1391951469', '1', '1', '15959579733', '1', '1', 1, 1, '1', 0, 1, 0, 'http://weixin.m.haoid.cn/uploads/file/20140203134502579.png');
...
(1, 'idgzas1391869476', '3', '123', '2014-02-10', '2014-02-13', 0, '', '', '');
...
CREATE TABLE IF NOT EXISTS `tp_fang` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
  `keyword` varchar(100) NOT NULL,
  `title` varchar(200) DEFAULT NULL,
...
--
-- 表的结构 `tp_fang_dianping`
--

CREATE TABLE IF NOT EXISTS `tp_fang_dianping` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tp_fang_effect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
  `show_order` int(5) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tp_fang_hu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tp_fang_photo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
...
--
-- 转存表中的数据 `tp_fang_photo`
--

INSERT INTO `tp_fang_photo` (`id`, `token`, `name`, `show_order`, `info`, `topic1`, `topic2`, `topic3`, `topic4`, `topic5`, `topic6`, `topic7`, `topic8`, `pid`) VALUES
(21, 'iftawp1390227576', '楼盘相册', 1, '<span>太宏伟壮观~</span>', 'http://dkjingyou.gotoip1.com/Uploads/image/20140116/52d82b1230bca.jpg', 'http://dkjingyou.gotoip1.com/Uploads/image/20140116/52d82b1c79375.jpg', 'http://dkjingyou.gotoip1.com/Uploads/image/20140116/52d82b405e83b.jpg', '', '', '', '', '', 76);
...
CREATE TABLE IF NOT EXISTS `tp_fang_zi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
  `name` varchar(100) DEFAULT NULL,
  `show_order` int(10) DEFAULT NULL,
...
(1, 'o5SultzIMYh3NH99-iWvS9prZIm8', 'gh_c53858b25f59', 1391869814),
(2, 'o5Sult3HM_pqKW-KmK3f-lv7yVw4', 'gh_c53858b25f59', 1391951225),
(3, 'oI-IhuBfOWLBOZ5_hvPSkhWlwJJ4', 'gh_56c69e0007dd', 1392031490);
...
(4, 4, 0, '朗读', 'langdu', '朗读＋关键词　例：朗读云微多用户营销系统', 1, 1),
...
CREATE TABLE IF NOT EXISTS `tp_home` (
  ...
  `dianhua` char(200) NOT NULL COMMENT '商家电话',
...
INSERT INTO `tp_home` (`id`, `token`, `title`, `picurl`, `info`, `plugmenucolor`, `copyright`, `dianhua`, `homeurl`, `advancetpl`) VALUES
(40, 'iftawp1390227576', '欢迎访问飞海科技微信版3G网站', 'http://20140119.name.v513.com/Uploads/image/20140120/52dd38bc03441.jpg', '公司创立即秉持“诚信、负责、踏实”之宗旨，竭诚为广大客户提供最完善的服务，历经多年在本行业的钻研，以及本公司对品质的坚持，已赢得客户一致肯定。', '', '飞海科技版权所有', '021-83156999', 'http://20140119.name.v513.com/uploads/file/20140120145558173.jpg', 0),
(41, 'idgzas1391869476', '李云飞', 'http://mywx.n.ydgood.com/Uploads/image/20140208/52f640f6e52ff.jpg', '你好，李云飞测试', '#FF0000', '', '', '', 0),
(42, 'atjscl1391865717', '122332', 'http://mywx.n.ydgood.com/Uploads/image/20140210/52f88bc92450d.jpg', '1232121', '', '321321', '123123', '', 0),
(43, 'pioqvg1392027725', '乐宝儿摄影馆', 'http://mywx.n.ydgood.com/Uploads/image/20140210/52f8ba942622d.jpg', '乐宝儿摄影馆', '', '乐宝儿摄影馆', '02036685379', '', 0);
...
(293, '', 81, 'ipobao1388660365', 'Img'),
(292, '', 80, 'ipobao1388660365', 'Img'),
(289, '预约', 13, 'ipobao1388660365', 'Selfform'),
(288, '大转盘', 95, 'letrzs1388393729', 'Lottery'),
(287, '大转盘', 94, 'cxjloy1388392125', 'Lottery'),
(286, '324', 41, 'xeygde1388391247', 'Product'),
(285, '大转盘', 93, 'xeygde1388391247', 'Lottery'),
(284, '123', 92, 'tnvimm1388390990', 'Lottery'),
(283, '谈毅', 77, 'yycoxl1387385772', 'Img'),
(282, '', 76, 'yycoxl1387385772', 'Img'),
(281, '', 75, 'yycoxl1387385772', 'Img'),
(280, '', 74, 'yycoxl1387385772', 'Img'),
(279, '', 73, 'yycoxl1387385772', 'Img'),
(278, '', 72, 'yycoxl1387385772', 'Img'),
(277, '', 71, 'yycoxl1387385772', 'Img'),
(276, '', 70, 'yycoxl1387385772', 'Img'),
(275, '', 69, 'yycoxl1387385772', 'Img'),
(274, '石梅湾国际', 68, 'yycoxl1387385772', 'Img'),
(273, '华润石梅', 67, 'nwdbkw1386839277', 'Img'),
(272, '楼盘', 66, 'yycoxl1387385772', 'Img'),
(245, '连衣裙', 30, 'nwdbkw1386839277', 'Product'),
(246, '披肩', 31, 'nwdbkw1386839277', 'Product'),
(247, '凉菜', 32, 'nwdbkw1386839277', 'Product'),
(248, '开胃', 33, 'nwdbkw1386839277', 'Product'),
(249, '红油', 34, 'nwdbkw1386839277', 'Product'),
(250, '鸡翅', 35, 'nwdbkw1386839277', 'Product'),
(251, '猴头菇', 36, 'nwdbkw1386839277', 'Product'),
(252, '酸笋', 37, 'nwdbkw1386839277', 'Product'),
(253, '鲜蔬海带汤', 38, 'nwdbkw1386839277', 'Product'),
(254, '莲藕排骨汤', 39, 'nwdbkw1386839277', 'Product'),
(255, '紫薯银耳汤', 40, 'nwdbkw1386839277', 'Product'),
(256, '喜帖', 33, 'nwdbkw1386839277', 'Xitie'),
(257, '优惠', 84, 'nwdbkw1386839277', 'Lottery'),
(258, '刮刮卡', 85, 'nwdbkw1386839277', 'Lottery'),
(259, '大转盘', 86, 'nwdbkw1386839277', 'Lottery'),
(260, '砸金蛋', 87, 'nwdbkw1386839277', 'Lottery'),
(261, '检查', 12, 'nwdbkw1386839277', 'Selfform'),
(262, '大转盘', 88, 'vsmdvc1387015434', 'Lottery'),
(263, '优惠券', 89, 'vsmdvc1387015434', 'Lottery'),
(264, '刮刮卡', 90, 'vsmdvc1387015434', 'Lottery'),
(265, '砸金蛋', 91, 'vsmdvc1387015434', 'Lottery'),
(266, '喜帖', 34, 'vsmdvc1387015434', 'Xitie'),
(267, '新闻', 61, 'vsmdvc1387015434', 'Img'),
(268, '新闻', 62, 'vsmdvc1387015434', 'Img'),
(269, '新闻', 63, 'vsmdvc1387015434', 'Img'),
(270, '新闻', 64, 'vsmdvc1387015434', 'Img'),
(271, '关注123', 65, 'nwdbkw1386839277', 'Img'),
(326, '你好', 124, 'iftawp1390227576', 'Text'),
(327, '大转盘', 98, 'iftawp1390227576', 'Lottery'),
(328, '调查', 57, 'iftawp1390227576', 'Diaoyan'),
(329, '房产', 76, 'iftawp1390227576', 'Fang'),
(330, '预约2', 146, 'iftawp1390227576', 'Fang'),
(331, '医疗', 15, 'iftawp1390227576', 'Selfform'),
(332, '拔面王', 1, 'idgzas1391869476', 'Jiudian'),
(333, '3', 1, 'idgzas1391869476', 'Diaoyan'),
(334, '1199', 1, 'pioqvg1392027725', 'Product');
...
(98, 0, 0, 'iftawp1390227576', '大转盘', 'http://20140119.name.v513.com/tpl/Wap/default/common/css/guajiang/images/activity-lottery-start.jpg', '幸运大转盘活动开始了', '兑奖请联系我们，电话18950099999', '太厉害了。中奖了！', 1390147200, 1421683200, '亲，请点击进入大转盘抽奖活动页面，祝您好运哦！', '亲，继续努力哦！', '幸运大转盘活动已经结束了', 'http://20140119.name.v513.com/tpl/Wap/default/common/css/guajiang/images/activity-lottery-end.jpg', '亲，活动已经结束，请继续关注我们的后续活动哦。', '取暖器一台', 1, 0, '洗衣机一台', 1, 1, 0, '美的微波炉一台', 1, 0, 3000, 10, 0, '', '', 1, 1390230128, 1, '格兰仕热水壶一只', 1, 0, '', 0, 0, '', 0, 0, '');
...
(544, 98, 1, 'o8vu5uPPo8V6VmxQnsS54y74kr7o', 'iftawp1390227576', 0, '', '', '', 0, '', 0, 0);
...
(1, 'pzjxew1391951469', 'vip10002', ''),
(2, 'pzjxew1391951469', 'vip10003', ''),
(3, 'pzjxew1391951469', 'vip10004', ''),
(4, 'pzjxew1391951469', 'vip10005', ''),
(5, 'pzjxew1391951469', 'vip10006', ''),
(6, 'pzjxew1391951469', 'vip10007', ''),
(7, 'pzjxew1391951469', 'vip10008', ''),
(8, 'pzjxew1391951469', 'vip10009', ''),
(9, 'pzjxew1391951469', 'vip10010', ''),
(10, 'pzjxew1391951469', 'vip10011', ''),
(11, 'pzjxew1391951469', 'vip10012', ''),
(12, 'pzjxew1391951469', 'vip10013', ''),
(13, 'pzjxew1391951469', 'vip10014', ''),
(14, 'pzjxew1391951469', 'vip10015', ''),
(15, 'pzjxew1391951469', 'vip10016', ''),
(16, 'pzjxew1391951469', 'vip10017', ''),
(17, 'pzjxew1391951469', 'vip10018', ''),
(18, 'pzjxew1391951469', 'vip10019', ''),
(19, 'pzjxew1391951469', 'vip10020', ''),
(20, 'pzjxew1391951469', 'vip10021', ''),
(21, 'pzjxew1391951469', 'vip10022', ''),
(22, 'pzjxew1391951469', 'vip10023', ''),
(23, 'pzjxew1391951469', 'vip10024', ''),
(24, 'pzjxew1391951469', 'vip10025', ''),
(25, 'pzjxew1391951469', 'vip10026', ''),
(26, 'pzjxew1391951469', 'vip10027', ''),
(27, 'pzjxew1391951469', 'vip10028', ''),
(28, 'pzjxew1391951469', 'vip10029', ''),
(29, 'pzjxew1391951469', 'vip10030', ''),
(30, 'pzjxew1391951469', 'vip10031', ''),
(31, 'pzjxew1391951469', 'vip10032', ''),
(32, 'pzjxew1391951469', 'vip10033', ''),
(33, 'pzjxew1391951469', 'vip10034', ''),
(34, 'pzjxew1391951469', 'vip10035', ''),
(35, 'pzjxew1391951469', 'vip10036', ''),
(36, 'pzjxew1391951469', 'vip10037', ''),
(37, 'pzjxew1391951469', 'vip10038', ''),
(38, 'pzjxew1391951469', 'vip10039', ''),
(39, 'pzjxew1391951469', 'vip10040', ''),
(40, 'pzjxew1391951469', 'vip10041', ''),
(41, 'pzjxew1391951469', 'vip10042', ''),
(42, 'pzjxew1391951469', 'vip10043', ''),
(43, 'pzjxew1391951469', 'vip10044', ''),
(44, 'pzjxew1391951469', 'vip10045', ''),
(45, 'pzjxew1391951469', 'vip10046', ''),
(46, 'pzjxew1391951469', 'vip10047', ''),
(47, 'pzjxew1391951469', 'vip10048', ''),
(48, 'pzjxew1391951469', 'vip10049', ''),
(49, 'pzjxew1391951469', 'vip10050', ''),
(50, 'pzjxew1391951469', 'vip10051', ''),
(51, 'pzjxew1391951469', 'vip10052', ''),
(52, 'pzjxew1391951469', 'vip10053', ''),
(53, 'pzjxew1391951469', 'vip10054', ''),
(54, 'pzjxew1391951469', 'vip10055', ''),
(55, 'pzjxew1391951469', 'vip10056', ''),
(56, 'pzjxew1391951469', 'vip10057', ''),
(57, 'pzjxew1391951469', 'vip10058', ''),
(58, 'pzjxew1391951469', 'vip10059', ''),
(59, 'pzjxew1391951469', 'vip10060', ''),
(60, 'pzjxew1391951469', 'vip10061', ''),
(61, 'pzjxew1391951469', 'vip10062', ''),
(62, 'pzjxew1391951469', 'vip10063', ''),
(63, 'pzjxew1391951469', 'vip10064', ''),
(64, 'pzjxew1391951469', 'vip10065', ''),
(65, 'pzjxew1391951469', 'vip10066', ''),
(66, 'pzjxew1391951469', 'vip10067', ''),
(67, 'pzjxew1391951469', 'vip10068', ''),
(68, 'pzjxew1391951469', 'vip10069', ''),
(69, 'pzjxew1391951469', 'vip10070', ''),
(70, 'pzjxew1391951469', 'vip10071', ''),
(71, 'pzjxew1391951469', 'vip10072', ''),
(72, 'pzjxew1391951469', 'vip10073', ''),
(73, 'pzjxew1391951469', 'vip10074', ''),
(74, 'pzjxew1391951469', 'vip10075', ''),
(75, 'pzjxew1391951469', 'vip10076', ''),
(76, 'pzjxew1391951469', 'vip10077', ''),
(77, 'pzjxew1391951469', 'vip10078', ''),
(78, 'pzjxew1391951469', 'vip10079', ''),
(79, 'pzjxew1391951469', 'vip10080', ''),
(80, 'pzjxew1391951469', 'vip10081', ''),
(81, 'pzjxew1391951469', 'vip10082', ''),
(82, 'pzjxew1391951469', 'vip10083', ''),
(83, 'pzjxew1391951469', 'vip10084', ''),
(84, 'pzjxew1391951469', 'vip10085', ''),
(85, 'pzjxew1391951469', 'vip10086', ''),
(86, 'pzjxew1391951469', 'vip10087', ''),
(87, 'pzjxew1391951469', 'vip10088', ''),
(88, 'pzjxew1391951469', 'vip10089', ''),
(89, 'pzjxew1391951469', 'vip10090', ''),
(90, 'pzjxew1391951469', 'vip10091', ''),
(91, 'pzjxew1391951469', 'vip10092', ''),
(92, 'pzjxew1391951469', 'vip10093', ''),
(93, 'pzjxew1391951469', 'vip10094', ''),
(94, 'pzjxew1391951469', 'vip10095', ''),
(95, 'pzjxew1391951469', 'vip10096', ''),
(96, 'pzjxew1391951469', 'vip10097', ''),
(97, 'pzjxew1391951469', 'vip10098', ''),
(98, 'pzjxew1391951469', 'vip10099', ''),
(99, 'pzjxew1391951469', 'vip10100', '');
...
CREATE TABLE IF NOT EXISTS `tp_member_card_set` (
  ...
  `xiangce` varchar(255) NOT NULL COMMENT '相册头部',
...
(16, 'ykqxic1387040277', 'o8vu5uPPo8V6VmxQnsS54y74kr7o', '饭店', 1387041763);
...
(41, 'edit', '微信图文编辑', 1, '0', 38, 3, NULL, 0, 2),
(42, 'del', '微信图文删除', 1, '0', 38, 3, NULL, 0, 2),
...
(1, 1, 1, '1199宝宝照套系', 1199, 1199, 10, '<h3>\r\n	<img src="/Uploads/image/20140210/52f8aef72f48a.jpg" alt="" /><br />\r\n</h3>', 'pioqvg1392027725', '1199', 2, 'http://mywx.n.ydgood.com/Uploads/image/20140210/52f8ae97e934d.jpg', 0, 0, 0, 0, 1392029479);
...
(1, 'pioqvg1392027725', 'oCC79joPwQbwo_dy3DQr-RWs8wzM', 'a:1:{i:1;a:2:{s:5:"count";i:1;s:5:"price";d:1199;}}', 1, 1199, '盛永', '18929536506', '白云万达', 0, 0, 1392029854, '', 0, 0, 0, 0, 0, 0, 0, 0, 0, 'oCC79joPwQbwo_dy3DQr-RWs8wzM1392029854', 0, '', ''),
(2, 'pioqvg1392027725', 'oCC79joPwQbwo_dy3DQr-RWs8wzM', 'a:1:{i:1;a:2:{s:5:"count";i:1;s:5:"price";d:1199;}}', 1, 1199, '盛永', '18929536506', '白云万达', 0, 0, 1392029923, '', 0, 0, 0, 0, 0, 0, 0, 0, 0, 'oCC79joPwQbwo_dy3DQr-RWs8wzM1392029923', 0, '', '');
...
(1, 1, 1, 1199, 1, 'oCC79joPwQbwo_dy3DQr-RWs8wzM', 'pioqvg1392027725', 1392029854),
(2, 2, 1, 1199, 1, 'oCC79joPwQbwo_dy3DQr-RWs8wzM', 'pioqvg1392027725', 1392029923);
...
(1, 'pioqvg1392027725', '宝宝照', '宝宝照', 0, 'http://mywx.n.ydgood.com/Uploads/image/20140210/52f8adcd08d46.jpg', 0, 1392029197);
...
CREATE TABLE IF NOT EXISTS `tp_pyiliao` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
  `keyword` varchar(100) NOT NULL,
  `title` varchar(200) DEFAULT NULL,
...
--
-- 表的结构 `tp_pyiliao_order`
--

CREATE TABLE IF NOT EXISTS `tp_pyiliao_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
...
(1, 'iftawp1390227576', 2014, 1, 20, 1390228684, 4, 0, 0, 2, 0, 0, 0),
(2, 'iftawp1390227576', 2014, 1, 21, 1390234444, 4, 0, 0, 2, 0, 0, 0),
(3, 'idgzas1391869476', 2014, 2, 8, 1391869796, 8, 0, 0, 1, 1, 0, 0),
(4, 'idgzas1391869476', 2014, 2, 9, 1391923406, 34, 0, 0, 11, 1, 0, 0),
(5, 'idgzas1391869476', 2014, 2, 10, 1391996083, 6, 0, 0, 5, 0, 0, 0),
(6, 'pioqvg1392027725', 2014, 2, 10, 1392029628, 10, 0, 0, 2, 0, 0, 0),
(7, 'insebz1390711871', 2014, 2, 10, 1392031504, 0, 0, 0, 0, 1, 0, 0);
...
(15, 'iftawp1390227576', '预约体检检查', '医疗', '欢迎体验生活健康，来自上海某某某医院', '上海市第二人民医院上海市第二人民医院，原名“上海医院”，创立于1904年，是中国人在上海自己创建的第一所中、西医综合性医院。上海市第二人民医院座落于上海著名的南浦大桥桥垝下多稼路两侧，东临黄浦江，西至中山南路，占地面积21.8亩。建筑群主要为外科、内楼大楼、门急诊楼、眼科中心楼、医技楼、行政楼等，总建筑面积24700平方米。', 1390237673, '预约成功', '预约失败！', 1391183999, 'http://20140119.name.v513.com/Uploads/image/20140120/52dd57be404d0.jpg');
...
(2, 12, '姓名', 'name', 'text', '', 1, '', 1, '必须填写名字'),
(3, 12, '电话', 'dianhua', 'text', '', 1, '', 2, '电话号码错误'),
(4, 12, '您的性别', 'sex', 'select', '男士|女士', 1, '', 3, '请选择性别'),
(5, 12, '意向', 'yix', 'textarea', '', 0, '', 4, ''),
(6, 14, '入住人姓名', 'name', 'text', '', 1, '随便输入哦', 1, '错误提示'),
(7, 14, '入住人证件', 'id', 'text', '', 1, '', 2, ''),
(8, 14, '入住时间', 'intime', 'textarea', '', 1, '日期', 3, ''),
(9, 15, '电话', 'tel', 'text', '', 1, '', 1, '格式错误'),
(10, 15, '您微信号', 'weixinhao', 'text', '', 0, '', 2, '对不起，输入有误');
...
(7, 15, 'o8vu5uPPo8V6VmxQnsS54y74kr7o', 'a:2:{s:3:"tel";s:6:"默默";s:9:"weixinhao";s:3:"摸";}', 1390237823);
...
(1, NULL, 'eottoi1387958696', 'person', '1', '1', 'yuyue'),
(2, NULL, 'eottoi1387958696', 'phone', '1', '1', 'yuyue'),
(3, NULL, 'eottoi1387958696', 'date', '1', '2', 'yuyue'),
(4, NULL, 'eottoi1387958696', 'time', '1', '2', 'yuyue'),
(7, NULL, 'eottoi1387958696', 'sds', 'sd|sad|sd', '4', 'yuyue'),
(8, NULL, 'eottoi1387958696', '525', 'asdasda', '5', 'yuyue'),
(14, NULL, 'udsbia1387635160', 'person', '1', '1', 'yuyue'),
(15, NULL, 'udsbia1387635160', 'phone', '1', '1', 'yuyue'),
(16, NULL, 'udsbia1387635160', 'date', '1', '2', 'yuyue'),
(17, NULL, 'udsbia1387635160', 'time', '1', '2', 'yuyue'),
(18, NULL, 'udsbia1387635160', '11111', NULL, '5', 'yuyue'),
(19, NULL, 'udsbia1387635160', '123', '123', '3', 'yuyue'),
(21, NULL, 'udsbia1387635160', '234', '11|22|33', '4', 'yuyue'),
(22, NULL, 'ieediw1388156675', 'person', '1', '1', 'yiliao'),
(23, NULL, 'ieediw1388156675', 'phone', '1', '1', 'yiliao'),
(24, NULL, 'ieediw1388156675', 'date', '1', '2', 'yiliao'),
(25, NULL, 'ieediw1388156675', 'time', '1', '2', 'yiliao'),
(26, NULL, 'ieediw1388156675', 'treatment', '1', '6', 'yiliao'),
(27, NULL, 'ieediw1388156675', '留言', NULL, '5', 'yiliao'),
(28, NULL, 'ieediw1388156675', 'asd', '12323', '3', 'yuyue'),
(29, NULL, 'ieediw1388156675', 'dds', 'bvh|dec|fr', '4', 'yuyue'),
(42, 42, 'ieediw1388156675', 'person', '1', '1', 'yuyue'),
(43, 42, 'ieediw1388156675', 'phone', '1', '1', 'yuyue'),
(44, 42, 'ieediw1388156675', 'date', '1', '2', 'yuyue'),
(45, 42, 'ieediw1388156675', 'time', '1', '2', 'yuyue'),
(46, 42, 'ieediw1388156675', '预约菜式', '请输入你要的菜', '3', 'yuyue'),
(47, 42, 'ieediw1388156675', '好多好多', '就|一|个', '4', 'yuyue'),
(74, 42, 'ieediw1388156675', '留言', NULL, '5', 'yuyue'),
(75, 48, 'ieediw1388156675', 'person', '1', '1', 'yuyue'),
(76, 48, 'ieediw1388156675', 'phone', '1', '1', 'yuyue'),
(77, 48, 'ieediw1388156675', 'date', '1', '2', 'yuyue'),
(78, 48, 'ieediw1388156675', 'time', '1', '2', 'yuyue'),
(79, 49, 'gcoksb1386665613', 'person', '1', '1', 'yuyue'),
(80, 49, 'gcoksb1386665613', 'phone', '1', '1', 'yuyue'),
(81, 49, 'gcoksb1386665613', 'date', '1', '2', 'yuyue'),
(82, 49, 'gcoksb1386665613', 'time', '1', '2', 'yuyue'),
(83, 140, 'qmegun1389783918', 'person', '1', '1', 'Jiudian'),
(84, 140, 'qmegun1389783918', 'phone', '1', '1', 'Jiudian'),
(85, 140, 'qmegun1389783918', 'date', '1', '2', 'Jiudian'),
(86, 140, 'qmegun1389783918', 'time', '1', '2', 'Jiudian'),
(87, 141, 'qmegun1389783918', 'person', '1', '1', 'Yiliao'),
(88, 141, 'qmegun1389783918', 'phone', '1', '1', 'Yiliao'),
(89, 141, 'qmegun1389783918', 'date', '1', '2', 'Yiliao'),
(90, 141, 'qmegun1389783918', 'time', '1', '2', 'Yiliao'),
(91, 141, 'qmegun1389783918', NULL, NULL, '5', 'Yiliao'),
(92, 141, 'qmegun1389783918', '您要预约的医师', '请输入您要预约的医师名字', '3', 'Yiliao'),
(93, 141, 'qmegun1389783918', '医疗科目', '门诊|急诊|口腔科|神经科', '4', 'Yiliao'),
(94, 141, 'qmegun1389783918', '', NULL, '5', 'Yiliao'),
(103, 142, 'nwdbkw1386839277', 'person', '1', '1', 'Jiudian'),
(104, 142, 'nwdbkw1386839277', 'phone', '1', '1', 'Jiudian'),
(105, 142, 'nwdbkw1386839277', 'date', '1', '2', 'Jiudian'),
(106, 142, 'nwdbkw1386839277', 'time', '1', '2', 'Jiudian'),
(107, NULL, 'nwdbkw1386839277', 'person', '1', '1', 'Jiudian'),
(108, NULL, 'nwdbkw1386839277', 'phone', '1', '1', 'Jiudian'),
(109, NULL, 'nwdbkw1386839277', 'date', '1', '2', 'Jiudian'),
(110, NULL, 'nwdbkw1386839277', 'time', '1', '2', 'Jiudian'),
(111, NULL, 'nwdbkw1386839277', 'person', '1', '1', 'Yiliao'),
(112, NULL, 'nwdbkw1386839277', 'phone', '1', '1', 'Yiliao'),
(113, NULL, 'nwdbkw1386839277', 'date', '1', '2', 'Yiliao'),
(114, NULL, 'nwdbkw1386839277', 'time', '1', '2', 'Yiliao'),
(115, 143, 'nwdbkw1386839277', 'person', '1', '1', 'Yiliao'),
(116, 143, 'nwdbkw1386839277', 'phone', '1', '1', 'Yiliao'),
(117, 143, 'nwdbkw1386839277', 'date', '1', '2', 'Yiliao'),
(118, 143, 'nwdbkw1386839277', 'time', '1', '2', 'Yiliao'),
(119, 143, 'nwdbkw1386839277', '留言', NULL, '5', 'Yiliao'),
(120, 143, 'nwdbkw1386839277', '您要预约的医师', '请输入您要预约的医师名字', '3', 'Yiliao'),
(121, 143, 'nwdbkw1386839277', '医疗科目', '门诊|急诊|口腔科|神经科', '4', 'Yiliao'),
(122, 144, 'cxjloy1388392125', 'person', '1', '1', 'Jiudian'),
(123, 144, 'cxjloy1388392125', 'phone', '1', '1', 'Jiudian'),
(124, 144, 'cxjloy1388392125', 'date', '1', '2', 'Jiudian'),
(125, 144, 'cxjloy1388392125', 'time', '1', '2', 'Jiudian'),
(126, 144, 'cxjloy1388392125', '留言', NULL, '5', 'Jiudian'),
(127, 145, 'cxjloy1388392125', 'person', '1', '1', 'Yiliao'),
(128, 145, 'cxjloy1388392125', 'phone', '1', '1', 'Yiliao'),
(129, 145, 'cxjloy1388392125', 'date', '1', '2', 'Yiliao'),
(130, 145, 'cxjloy1388392125', 'time', '1', '2', 'Yiliao'),
(131, 145, 'cxjloy1388392125', '留言', NULL, '5', 'Yiliao'),
(132, 146, 'iftawp1390227576', 'person', '1', '1', 'Fang'),
(133, 146, 'iftawp1390227576', 'phone', '1', '1', 'Fang'),
(134, 146, 'iftawp1390227576', 'date', NULL, '2', 'Fang'),
(135, 146, 'iftawp1390227576', 'time', '1', '2', 'Fang'),
(136, 146, 'iftawp1390227576', '留言', NULL, '5', 'Fang'),
(137, 146, 'iftawp1390227576', '预约代理人', '', '3', 'Fang');
...
INSERT INTO `tp_shake` (`id`, `isact`, `acttitle`, `isopen`, `clienttime`, `showtime`, `shownum`, `pass`, `joinnum`, `shaketype`, `token`, `createtime`, `endtime`, `pass2`, `pass3`, `starttime`, `endshake`, `qrcode`) VALUES
(63, 1, '默认活动', 1, 3, 3, 10, '', NULL, 1, 'iftawp1390227576', '1390231416', NULL, '', '', 3, 133, 'http://am.discuz.qq.com/qrcode?s=http%3A%2F%2Fam.discuz.qq.com%2Fget%3FisQRCode%3D1%26sId%3D1395886%26ts%3D1390231403%26sig%3D65fe9d33802ed06de18b2896');
...
CREATE TABLE IF NOT EXISTS `tp_site_plugmenu` (
  ...
  `url` varbinary(100) DEFAULT NULL,
  `taxis` mediumint(4) NOT NULL DEFAULT '0',
...
('idgzas1391869476', 'tel', '18942332455', 0, 0),
('idgzas1391869476', 'memberinfo', '', 0, 0),
('idgzas1391869476', 'nav', '', 0, 0),
('idgzas1391869476', 'message', NULL, 0, 0),
('idgzas1391869476', 'share', '', 0, 0),
('idgzas1391869476', 'home', '', 0, 0),
('idgzas1391869476', 'album', '', 0, 0),
('idgzas1391869476', 'email', '', 0, 0),
('idgzas1391869476', 'shopping', '', 0, 0),
('idgzas1391869476', 'membercard', '', 0, 0),
('idgzas1391869476', 'activity', '', 0, 0),
('idgzas1391869476', 'weibo', '', 0, 0),
('idgzas1391869476', 'tencentweibo', '', 0, 0),
('idgzas1391869476', 'qqzone', '', 0, 0),
('idgzas1391869476', 'wechat', '', 0, 0),
('idgzas1391869476', 'music', '', 0, 0),
('idgzas1391869476', 'video', '', 0, 0),
('idgzas1391869476', 'recommend', '', 0, 0),
('idgzas1391869476', 'other', '', 0, 0);
...
INSERT INTO `tp_toshake` (`id`, `phone`, `token`, `wecha_id`, `point`) VALUES
(190, '15085596633', 'nwdbkw1386839277', 'oTAfcjg7dipoH2lND315ZvvzxJ7Q', 61),
(189, '13601123655', 'jqrgec1390101344', 'odek7t-af63MY6vMXQ_k6G_gOyuU', 3),
(188, '18796115060', 'nwdbkw1386839277', 'oTAfcjsmQYNPyP3YaLkOayy61SlM', 143),
(191, '13921492888', 'iftawp1390227576', 'o8vu5uPPo8V6VmxQnsS54y74kr7o', 133);
...
INSERT INTO `tp_userinfo` (`id`, `token`, `wecha_id`, `wechaname`, `truename`, `tel`, `qq`, `sex`, `age`, `birthday`, `address`, `info`, `total_score`, `sign_score`, `expend_score`, `continuous`, `add_expend`, `add_expend_time`, `live_time`, `getcardtime`) VALUES
(1, 'pioqvg1392027725', 'oCC79joPwQbwo_dy3DQr-RWs8wzM', '', '盛永', '18929536506', 0, -1, 0, '', '白云万达', '', 0, 0, 0, 0, 0, 0, 0, 1);
...
(3, 'vip2', 4000, 4000, 1, 4, 50, 0, 80, 400, 1),
...
CREATE TABLE IF NOT EXISTS `tp_wewall` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tp_wewall` (`id`, `acttitle`, `isact`, `ifcheck`, `iflottery`, `showtime`, `background`, `marklog`, `createtime`, `endtime`, `token`, `bonu1`, `bonu2`, `bonu3`) VALUES
(22, '微信上墙', 2, 0, 0, 3, 'http://20140119.name.v513.com/Uploads/image/20140120/52dd4c730eb5c.jpg', NULL, 1390234416, 1390234783, 'iftawp1390227576', 1, 3, 5),
(23, '默认活动', 0, 0, 0, 3, '', NULL, 1390235011, NULL, 'iftawp1390227576', 1, 3, 5);
...
CREATE TABLE IF NOT EXISTS `tp_wewalllog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tp_wxuser` (
  ...
  `email` text CHARACTER SET armscii8 NOT NULL COMMENT '邮箱地址',
  `emailstatus` text CHARACTER SET armscii8 NOT NULL COMMENT '邮箱开始',
  `emailuser` text CHARACTER SET armscii8 NOT NULL COMMENT '邮箱QQ',
  `emailpassword` text CHARACTER SET armscii8 NOT NULL COMMENT '邮箱QQ密码',
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
  KEY `uid_2` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;
...
INSERT INTO `tp_yuyue` (`id`, `token`, `keyword`, `title`, `address`, `longitude`, `latitude`, `phone`, `topic`, `info`, `statdate`, `enddate`, `type`, `copyright`, `yuyue_type`) VALUES
(1, 'idgzas1391869476', '拔面王', '拔面王欢迎你', '', '', '', '18625877441', '', '', '2014-02-08', '2014-02-11', 'Jiudian', '归拔面王所有', NULL);
...
CREATE TABLE IF NOT EXISTS `tp_zhu_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tp_zi_menu` (
